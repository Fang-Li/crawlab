...
export declare const useForm: <T extends BaseModel>(ns: ListStoreNamespace, store: Store<RootStoreState>, services: Services<T>, data: FormComponentData<T>) => {
    getNewForm: DefaultFormFunc<any>;
    getNewFormList: () => any[];
    form: import("vue").ComputedRef<T>;
    ...
    formList: import("vue").ComputedRef<T[]>;
