...
import { DecoratorNode, DOMExportOutput, EditorConfig, LexicalEditor, LexicalNode, SerializedLexicalNode, Spread, TextFormatType } from 'lexical';
...
export declare class VariableNode extends DecoratorNode<JSX.Element> {
    ...
    __strikethrough: boolean;
    __selected: boolean;
    constructor({ key, category, name, __bold, __italic, __underline, __strikethrough, }: SerializedVariableNode);
...
export declare function $createVariableNode(params: SerializedVariableNode): VariableNode;
