...
export declare const getMenuItemPathMap: (rootPath: string, item: MenuItem) => Map<string, string>;
export declare const getAllMenuItemPathMap: () => Map<string, string>;
export declare const getRouteSelectOptions: () => CheckboxTreeSelectOption[];
export declare const getLabelByRouteConcept: (concept: RouteConcept) => string;
