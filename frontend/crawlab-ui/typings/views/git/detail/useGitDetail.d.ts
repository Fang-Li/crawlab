declare const useGitDetail: () => {
    ...
    commitLoading: import("vue").Ref<boolean, boolean>;
    onCommit: () => Promise<void>;
    rollbackLoading: import("vue").Ref<boolean, boolean>;
    onRollback: () => Promise<void>;
    pullLoading: import("vue").Ref<boolean, boolean>;
    onPull: () => Promise<void>;
    pushLoading: import("vue").Ref<boolean, boolean>;
    onPush: () => Promise<void>;
    ...
    navItems: import("vue").ComputedRef<NavItem<Git>[]>;
