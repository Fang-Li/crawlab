declare const useTokenList: () => {
    navActions?: import("vue").Ref<ListActionGroup[]>;
    tableLoading: import("vue").Ref<boolean>;
    tableColumns?: import("vue").Ref<TableColumns<Token>, TableColumns<Token>> | undefined;
    tableData: import("vue").Ref<TableData<Token>, TableData<Token>>;
